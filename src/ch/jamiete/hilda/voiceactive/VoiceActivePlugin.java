 ...
 *******************************************************************************/
package ch.jamiete.hilda.voiceactive;
...
public class VoiceActivePlugin extends HildaPlugin {
    ...
    public VoiceActivePlugin(final Hilda hilda) {
        super(hilda);
    }
    ...
    public void onEnable() {
        this.getHilda().getCommandManager().registerChannelCommand(new VoiceBaseCommand(this.getHilda(), this));
